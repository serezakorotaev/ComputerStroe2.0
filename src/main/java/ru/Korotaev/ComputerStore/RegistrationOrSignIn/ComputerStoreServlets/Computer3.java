...
/***
 * This class with doGet method which forwarded on jsp page with Computer3.
 ...
 */
public class Computer3 extends HttpServlet {
    /**
     * This method send on jsp page which show Computer3
     *
     * @param req  - request
     * @param resp - response
    ...
    protected void doPost(HttpServletRequest req , HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (newCount < 0) {
            ...
            computerDao.updateComputer(newCount , 3);
